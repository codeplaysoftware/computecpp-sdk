...
mv /tmp/tmp_builtins /tmp/ComputeCpp-CE-0.2.0-Linux/include/CL/sycl_builtins.h.h
...
sed -ie 's/isgreaaterequal/isgreaterequal/'  /tmp/ComputeCpp-CE-0.2.0-Linux/include/SYCL/host_relational_builtins.h
