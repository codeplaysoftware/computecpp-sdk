...
- ComputeCpp_DIR. This variable should be the root directory of the
...
tests/ subdirectory to the build, which will causes Gtest-based programs
testing the legacy pointer and virtual pointer classes to be built. Some
samples have optional OpenMP support. You can enable it by setting
