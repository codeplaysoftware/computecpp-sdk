== Community Edition (Beta) v. 0.1.1
:toc:
...
The following example from the link:{computecppSamples}[ComputeCpp sample code] called "simple_vector_add" depicts the basic structure of a SYCL
application.
