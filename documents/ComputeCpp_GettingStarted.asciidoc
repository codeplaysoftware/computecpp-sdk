...
:imageCMakeGui: /codeplaysoftware/computecpp-sdk/wiki/images/computecpp_cmakegui.png
endif::env-github[]
...
:imageComputeCppInfo: images/computecpp_info.svg
:imageCMakeGui: images/computecpp_cmakegui.png
...
the link:{computecppOverview}[ComputeCpp Overview] section.
