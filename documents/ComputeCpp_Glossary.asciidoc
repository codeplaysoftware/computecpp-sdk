...
[[CommandGroupFunctor]]Command Group Functor::
...
[[CommandGroupScope]]Command Group Scope::
...
[[IntegrationHeader]]Integration Header::
...
[[SingleSourceMultiplePasses]]Single Source Multiple Compiler Passes::
...
[[SYCLHostDevice]]SYCL Host Device::
