...
If the ComputeCpp Runtime detects a SIGINT it will attempt to safely destroy the _sheduling_ thread and the underlying OpenCL implementation, aborting any
